...
then look at more than one file under ${home}/projects before you answer. cat the markdown. do not invent a source tree. oh-my-pi.md is contributions, not a checkout.
