...
| Need | Read |
|---|---|
| **Accepted behavior truth — how every mechanism works, and why** | [`spec/README.md`](https://github.com/atacolak/speech-core/blob/main/spec/README.md) |
| Enduring Speech Core purpose, authority boundaries, and invariants | [`CHARTER.md`](https://github.com/atacolak/speech-core/blob/main/CHARTER.md) |
| Product documentation map (reference & evidence) | [`docs/README.md`](https://github.com/atacolak/speech-core/blob/main/docs/README.md) |
| Current implementation, installed defaults, and honest limits | [`docs/current-state.md`](https://github.com/atacolak/speech-core/blob/main/docs/current-state.md) |
| Accepted Speech Core architectural directions | [`docs/decisions/`](https://github.com/atacolak/speech-core/blob/main/docs/decisions/) |
| Active Speech Core target and delivery sequence | [`docs/evolution/ACTIVE.md`](https://github.com/atacolak/speech-core/blob/main/docs/evolution/ACTIVE.md) |
| City-standard mapping and work namespace | [`rig.toml`](https://github.com/atacolak/speech-core/blob/main/rig.toml) |
...
- Human-hold degraded close: see [`spec/specs/speech-in-turn-lifecycle.md`](https://github.com/atacolak/speech-core/blob/main/spec/specs/speech-in-turn-lifecycle.md) (do not restate the threshold here).
...
The full installed-default table lives in [`docs/current-state.md`](https://github.com/atacolak/speech-core/blob/main/docs/current-state.md). Defaults originate in code and installed configuration; documentation must not become an independent configuration source.
...
Use [`docs/README.md`](https://github.com/atacolak/speech-core/blob/main/docs/README.md) as the canonical map. The most common references are:

- [`docs/current-state.md`](https://github.com/atacolak/speech-core/blob/main/docs/current-state.md) — what works right now;
- [`docs/seams.md`](https://github.com/atacolak/speech-core/blob/main/docs/seams.md) — current component boundaries and contracts;
- [`docs/turn-detection.md`](https://github.com/atacolak/speech-core/blob/main/docs/turn-detection.md) — exact EOU triggers and tuning knobs;
- [`docs/speech-output.md`](https://github.com/atacolak/speech-core/blob/main/docs/speech-output.md) — speech-out protocol and cancellation;
- [`docs/evolution/ACTIVE.md`](https://github.com/atacolak/speech-core/blob/main/docs/evolution/ACTIVE.md) — accepted target, current gap, and delivery sequence.
