...
inspect, control, and author systemd. cli first, optional mcp. writes exist only through plan/apply.
...
honest limit: no libsystemd, no dbus library, no async runtime. the cli default is the user instance.
