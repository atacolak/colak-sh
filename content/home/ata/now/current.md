...
long-lived fork work on oh-my-pi: keeping upstream main pristine, isolating local capabilities, and composing a daily runtime without mixing personal config into public patches. the contribution surface lives at `projects/oh-my-pi.md`. the rest of `projects/` is pamphlets, not checkouts.
